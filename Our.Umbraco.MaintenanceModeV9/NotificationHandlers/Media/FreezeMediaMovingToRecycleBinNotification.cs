...
{
    public class FreezeMediaMovingToRecycleBinNotification : INotificationHandler<MediaMovingToRecycleBinNotification>
    {
        private readonly IMaintenanceModeService _maintenanceModeService;
        private readonly IBackofficeUserAccessor _backofficeUserAccessor;
        public FreezeMediaMovingToRecycleBinNotification(IMaintenanceModeService maintenanceModeService, IBackofficeUserAccessor backofficeUserAccessor)
        {
